...
def sac_train_step(
    ...
    def state_metric_loss_fn(state_metric: EnsembleStateMetric):
        ...
        # h_sax = jax.lax.stop_gradient(h_sax)
        # h_xbs = jax.lax.stop_gradient(h_xbs)

        # jax.debug.print("h_min = {}", h_sax.min())
        # jax.debug.print("h_mean = {}", h_sax.mean())
        # jax.debug.print("h_max = {}", h_sax.max())

        # jax.debug.print("g_min = {}", g_sx.min())
        # jax.debug.print("g_mean = {}", g_sx.mean())
        # jax.debug.print("g_max = {}", g_sx.max())
